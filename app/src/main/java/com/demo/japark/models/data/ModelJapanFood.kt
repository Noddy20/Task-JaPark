...
@Keep
@Serializable
@Entity(tableName = "japan_foods", indices = [Index(value = ["name"], unique = true)])   //Using name as unique key because we don't have any unique Id
data class ModelJapanFood(
    ...
    companion object{
        ...
        val DIFF_UTIL = getDiffUtil<ModelJapanFood> { oldItem, newItem ->
